...
question_list = []
question_list.append(Question("Де знаходиться Чехія ?",'Європа','Азія','Америка','Африка'))
question_list.append(Question("Скільки океанів в світі ?",'5','7','6','4'))
question_list.append(Question("Скільки континентів в світі ?",'5','7','6','4'))
...
def check_answer():
    if answers[0].isChecked():
        ...
        window.score += 1
        print('Статистика\n-всього питань: ',window.total, "\n-правильниз відповідей: ",window.score)
